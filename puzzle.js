...
знания1.добавить(new Эквивалентность(new И(БЛжец, БРыцарь), АРыцарь, АЛжец))
знания1.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), БЛжец, БРыцарь))
...
знания2.добавить(new Эквивалентность(new И(БЛжец, БРыцарь), АРыцарь, АЛжец))
знания2.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), БЛжец, БРыцарь))
...
знания3.добавить(new Эквивалентность(new И(АЛжец, АРыцарь), БРыцарь, БЛжец))
знания3.добавить(new Эквивалентность(new И(БРыцарь, БЛжец), ВЛжец, ВРыцарь))
знания3.добавить(new Эквивалентность(new И(ВЛжец, ВРыцарь), АЛжец, АРыцарь))
